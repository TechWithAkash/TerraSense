...
export default function Home() {
  ...
  return (
    <div className="flex h-screen flex-col bg-[#F9FAFB] text-[#000000]">
      ...
      <header className="flex shrink-0 items-center justify-between border-b border-gray-200 bg-white/80 px-4 py-3 backdrop-blur-md sm:px-6">
        <div className="flex items-center gap-3">
          <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-[#0B1F16] text-[rgb(0,146,69)] shadow-sm">
            <LeafIcon className="h-4 w-4" />
          </div>
          <div>
            <div className="flex items-center gap-2">
              <span className="text-sm font-semibold tracking-tight text-[#000000]">
                Darukaa Earth
              </span>
              <span className="rounded-full bg-[#E8F7ED] px-2 py-0.5 text-[10px] font-semibold text-[rgb(0,146,69)] border border-[rgba(0,146,69,0.25)]">
                TerraSense
              </span>
            </div>
            <p className="text-[11px] text-gray-500 font-mono">Nature Intelligence Platform</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
